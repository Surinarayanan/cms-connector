...
public class Main {
  ...
  public static void main(String[] args) throws FileNotFoundException {
    args = new String[5];
    args[0] = "EXPORT"; // FLAT_FILE or EXPORT
    args[1] = "INPUT_PATH"; //
    args[2] = "OUTPUT_PATH";
    args[3] = "OVERLAY_PATH";
    args[4] = "CONFIG_FILE";
    ...
    String overlayPath =
        "/home/suriaravind/Documents/GameOfCodes/archon-content-management-connector/data/export/LoanReconciliationTemplate.pdf";
    String configFile =
        "/home/suriaravind/Documents/GameOfCodes/archon-content-management-connector/data/export/LoanReconciliationtemplateConfig.json";
    if (args[0].equalsIgnoreCase("FLAT_FILE")) {
